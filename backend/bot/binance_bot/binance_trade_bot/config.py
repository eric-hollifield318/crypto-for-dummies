# Config consts
from bot.binance_bot import binance_trade_bot
import configparser
import os

from .models import Coin

binance_trade_bot_dir = os.path.dirname(os.path.realpath(__file__))
CFG_FL_NAME = f"{binance_trade_bot_dir}/../user.cfg"
...
class Config:  # pylint: disable=too-few-public-methods,too-many-instance-attributes
    def __init__(self):
        ...
        # print(os.path.exists("supported_coin_list"))
        # print(os.path)
        ...
        self.SUPPORTED_COIN_LIST = config.get(USER_CFG_SECTION, "supported_coin_list").split()
        ...
        # print(self.SUPPORTED_COIN_LIST)
        # print(self.CURRENT_COIN_SYMBOL)
        # print(self.STRATEGY)
        # print(self.BINANCE_API_KEY)
        # print(self.BINANCE_API_SECRET_KEY)
